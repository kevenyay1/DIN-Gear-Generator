...
column2 = points 
for m in range(0, len(ToothListX)):
    msp.add_spline(ToothPoints[column1:column2]) 
...
for m in range(0, len(SpaceListX)):
    msp.add_spline(SpacePoints[column1:column2]) 
    column1 = column1 + points
    column2 = column2 + points
...
for m in range(0, z1* len(ShaftListX)):
    msp.add_spline(ShaftPoints[column1:column2]) 
    column1 = column1 + points
    column2 = column2 + points
...
for m in range(0, z1* len(HubListX)):
    msp.add_spline(HubPoints[column1:column2]) 
    column1 = column1 + points
    column2 = column2 + points
